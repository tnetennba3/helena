...
import illustratedBook from "../../../images/blog/i-read-my-first-book-in-japanese/illustrated-book.jpg"
...
export const query = graphql`
  query {
    allFile(
      filter: {
        relativeDirectory: {
          eq: "blog/i-read-my-first-book-in-japanese"
          ne: "blog/i-read-my-first-book-in-japanese/cover.png"
        }
      }
    ) {
      edges {
...
const BlogPost: React.FC<Props> = ({ data }) => {
  const findFluid = (name: string) => {
    const matchingEdge = data.allFile.edges.find(
      ({ node }) => node.childImageSharp.fluid.originalName === name
    )
    return matchingEdge?.node.childImageSharp.fluid as FluidObject
  }
  ...
  return (
    <Layout>
      ...
      <p>
        ...
        post, I describe my journey so far, approach to reading, and will
        present some fun stats and graphs I recorded along the way.
      </p>
      <p>
        ...
        socialise, or even go outside at all, meant I gained several hours a
        day. At first, I spent all that extra time playing Animal Crossing (
      ...
      <Figure
        fluid={findFluid("animal-crossing.jpg")}
      ...
      <p>
        ...
        dabbled a bit with language learning apps and lost interest quite
        quickly. Even though I am fortunate enough to understand a fair amount
        of Japanese already (thanks, mum), I just didn’t have much experience or
        confidence in being able to acquire a new language. My time learning
        French and German at school taught me that I could rote-learn vocabulary
        lists, memorise a script by heart and get decent exam results. But I
        didn’t retain any of that information a month later let alone years
        after I left school. The lesson I took away from it all was that{" "}
      ...
      <p>
        ...
        <em>learning how to learn</em>. I quickly realised, though it should
        have been obvious before, that picking up a second language isn’t
        anything special. Most sources say that over half of the world’s
        population is multilingual. Clearly, I didn’t need to be gifted or
        attuned to languages. I just needed time, dedication, and effective
        learning methods.
      </p>
      <Figure
        fluid={findFluid("average-languages-spoken.jpg")}
      ...
      />
      <p>
        I also discovered that it isn’t generally recommended to learn a
        language in the way I was taught at school. Rote-learning vocabulary
        lists and studying textbooks only get you so far. At some point you need
        to confront what you’ve learned in the real world. This can transform
        the vague, tenuous connections you have between foreign sounds and
        meaning in your native language into something concrete and meaningful
        in its own right. It’s that extra step between knowing that the bunch of
        lines <span lang="ja">青</span> can mean “green” <em>or</em> “blue” and
        having the correct colour wash over you, without thought, when seeing
      ...
      <p>
        This approach to language learning seemed very appealing. If I could
        pick up Japanese just by reading stuff in Japanese and listening to
        stuff in Japanese, that sounds like I could actually enjoy myself.
      </p>
      <p>
        At the start of April, I set my focus on improving my reading ability.
        Doing so would unlock a whole world of material to immerse myself in.
        But I was starting from pretty much square one. Japanese has three
        writing systems - hiragana, katakana and kanji. The first two I knew
        well enough at the time, there are only 46 characters in each. Kanji, on
        the other hand, is a whole other beast and has thousands of characters
        with multiple ways to read and understand each of them. I was familiar
        with about 20 kanji at the time. The average Japanese adult can read{" "}
        <em>over 3000</em>.
      </p>
      <Figure
        fluid={findFluid("kanji.png")}
      ...
      <p>
        ...
        techniques. In future, I might write another post going over the
        resources and methods I used in more detail. But for now, I’ll focus on
        how I tackled reading my first book in Japanese.{" "}
      ...
      <p>
        ...
        explore. It’s the reason a lot of people study a new language in the
        first place. So, you might be wondering why I chose a book that’s
        originally written in English. A story I’m already very familiar with
        and wouldn’t be getting much out of by reading it again in its impure,
        translated form.
      </p>
      <p>
      ...
      <p>
        ...
        second (<span lang="ja">帽子</span>) means “hat”. Without any knowledge
        of Harry Potter, this is quite a cryptic phrase and could leave you
        ...
        trouble with made-up names and phrases (which there are a lot of in
        Harry Potter). These nuggets of knowledge also acted as anchors in the
        story that would help me verify if I was understanding the text
        correctly.
      </p>
      <Figure
        fluid={findFluid("sorting-hat.jpg")}
      ...
      <p>
        As an aside, I also got my hands on a beautiful illustrated version of
        the book which has charming depictions of the magical world on every
        other page. This, again, helped set the scene and gave me clues to how
      ...
      <p>
        ...
        up as well as how long it was taking me to read each page. I knew I
        would be slow, much much slower than if I was reading in English so I
        needed a way to keep motivated. Having visibility over my improvement
        over time became that motivator. Knowing that, even if I’m going at a
        snail’s pace reading this children’s book, I am at least a lot faster
        than when I started out.
      </p>
      <p>
        How would I track these stats? Whenever I sat down to read Harry Potter,
        I used a stopwatch to record how long I was reading for. I also had a
        spreadsheet where I would enter each word or kanji I looked up. After
        each reading session, I would fill in the number of pages I read, the
        length of time, and the number of lookups.
      </p>
      <Figure
        fluid={findFluid("spreadsheet.png")}
        alt="Screenshot of my spreadsheet."
        caption="My very ugly spreadsheet."
      />
      <p>
        It was all fairly manual. At some point I would like to build an app
        that automates a lot of this for me.{" "}
        <small>
      ...
      <Figure
        fluid={findFluid("reading-stats-by-session.png")}
        alt="Graph showing my reading stats by session."
      />
      <p>
        The first page took me an <em>hour and a half</em> to read. But I
        improved quickly and dramatically. My average reading speed reduced to
        51 minutes per page by the end of the first chapter. In the final
        chapter, I was reading at a pace of 11 minutes a page.
      </p>
      <Figure
        fluid={findFluid("reading-stats-by-chapter.png")}
      ...
      <p>
        ...
        final chapter, I only needed to look up 13 words and 3 kanji per page.
        The decreased rate of lookups wasn’t the only reason my reading speed
        was increasing either. I was also getting better at distinguishing
        individual words within a sentence and acclimatising myself to the
        grammar.
      </p>
      <p>
        ...
        minutes. By chapter ten, I could read whole chapters in a single
        sitting, spending almost three hours doing so.
      </p>
      <p>
      ...
      <p>
        ...
        page, even sentence to sentence, the difficulty of the text you’re
        reading is going to fluctuate. And yet, it’s easy to lose sight of that
        in the moment. You might read a difficult text and think you’re not
        making any headway. But if you take a step back to view your journey
        over a wider time frame, it’s easy to see that you really are making
        progress. Tracking my stats helped me to gain that perspective. I could
        recognise that chapter eight was just a bump in the road (or spike in
        the graph) in my quest to get better.
      </p>
      <p>
        ...
        painful a book is to start with, I can make significant strides if I
        stick with it.
      </p>
      <Figure
        fluid={findFluid("hogwarts-owls.webp")}
        alt="Watercolour of Hogwarts and two owls soaring above."
      />
      <p>
        This year, my goal is to read <em>two Japanese books a month</em>! I
        will continue tracking my reading stats and hope to report back once
        I’ve read more.
      </p>
    </Layout>
  )
