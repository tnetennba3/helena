...
const BlogPost = () => (
  <Layout>
    ...
    <p>
      ...
      actively studying a new language. My time learning French and German at
      school taught me that I could rote-learn vocabulary lists, memorise a
    ...
    <p>
      ...
      been obvious before, that acquiring a second language isn’t anything
      ...
      to pick one up. I just needed time, dedication, and effective learning
      methods.
    </p>
    <Figure
    ...
    <p>
      ...
      would unlock a whole world of material to immerse myself in. But I was
      starting from pretty much square one. Japanese has three writing systems -
      hiragana, katakana and kanji. The first two I knew well enough at the
      time, there are only 46 characters in each. Kanji, on the other hand, is a
      whole other beast and has thousands of characters with multiple ways to
    ...
    <p>
      ...
      lighthouse and gave purpose to all my other Japanese studies.
    </p>
    <p>
    ...
    <p>
      ...
      written in English. A story I’m already very familiar with and won’t be
    ...
    <p>
      ...
      in the dictionary, I would discover that the first part (組み分け) means
      “division into groups” and the second (帽子) means “hat”. Without any
      knowledge of Harry Potter, this is quite a cryptic phrase and could leave
      you scratching your head for a while. For those of us that know the story,
      ...
      that meant I could guess where I was and verify if I was reading
      correctly.
    </p>
    <Figure
      src={sortingHat}
    ...
    />
    <p>
      Similarly, I just don’t have a great tolerance for ambiguity. I want to
      make sure I’m understanding every sentence, every detail when I’m taking
      something in. This sense of unease, that I’m missing something, is hard to
      be rid of if you’re reading in a language you lack confidence in. Better
    ...
    <p>
      ...
      snail’s pace reading this children’s book, I am at least a lot faster than
      when I started out.
    </p>
    <p>
    ...
    />
    <p>
      The tracking process was fairly manual. I would like to build an app that
      automates a lot of this for me. But this might just sit atop my list of
      projects that I never actually start. 🙈
    </p>
    <h2>Results</h2>
    ...
    <p>
      As you can see, it took me a <i>long time</i> to read Harry Potter and the
      Philosopher's Stone. To put it into perspective, I could have read over
      ten English novels in that time. But I expected that going into this
      journey. What I was more concerned about was whether my Japanese reading
      would improve over that time. And the answer is a definitive <em>yes</em>.
    </p>
    <Figure
    ...
    />
    <p>
      Right at the start, I was spending an hour and a half reading just one
      page. But I improved quickly and dramatically. My average reading speed
      reduced to 51 minutes per page by the end of the first chapter. In the
      final chapter, I was reading at a pace of 11 minutes per page.
    </p>
    <Figure
    ...
    />
    <p>
      The rate of lookups paints a similar picture. The first chapter had me
      ...
      decreased rate of lookups wasn’t the only explanatory factor in my
      increased reading speed either. I was also getting better at
      distinguishing individual words within a sentence and acclimatising myself
      to the grammar too.
    </p>
    <p>
      Not only was my Japanese reading ability advancing, to my surprise, my
      stamina grew as well. I started out reading just half a page at a time.
      Despite being very motivated (it was what the previous six months were
      leading up to after all), I found it so draining that I needed to take a
      break after 30-40 minutes. This then became another skill I developed over
      time. From chapter ten, I was able to read whole chapters in a single
    ...
    <p>
      Overall, I am really happy with the progress I made. Not all of it is
    ...
    <p>
      ...
      continue tracking my reading stats as I go along and hope to report back
      once I’ve read more.
    </p>
  </Layout>
)
